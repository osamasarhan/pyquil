...
import numpy as np
from rpcq.messages import BinaryExecutableResponse, QuiltBinaryExecutableResponse, ParameterAref, PyQuilExecutableResponse
...
class QAM(ABC):
    ...
    @_record_call
    def load(self, executable: Union[BinaryExecutableResponse, QuiltBinaryExecutableResponse, PyQuilExecutableResponse]) -> "QAM":
        """
        ...
        self._executable: Optional[
            Union[BinaryExecutableResponse, QuiltBinaryExecutableResponse, PyQuilExecutableResponse]
        ] = executable
