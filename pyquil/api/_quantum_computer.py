...
import numpy as np
from rpcq.messages import BinaryExecutableResponse, QuiltBinaryExecutableResponse, PyQuilExecutableResponse
...
ExecutableDesignator = Union[BinaryExecutableResponse, QuiltBinaryExecutableResponse, PyQuilExecutableResponse]
